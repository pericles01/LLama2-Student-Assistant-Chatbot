...
python llama_finetuning.py  --dataset alpaca_dataset --num_epochs 5 --use_peft --peft_method lora --quantization --use_fp16 --model_name /patht_of_model_folder/7B --output_dir Path/to/save/PEFT/model
